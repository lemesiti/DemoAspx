<%@ Page Async="true" Language="C#" AutoEventWireup="true" CodeBehind="GetDipendente.aspx.cs" Inherits="DemoAspx.GetDipendente" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Get Dipendente</title>
     ...
     <form id="form2" runat="server">
        <div class="container d-flex justify-content-center align-items-center" style="min-height: 75vh;">
            <div class="card p-lg-5" style="max-width: 400px;">
                <h1 class="mb-4">Dipendente</h1>
                <div class="mb-3">
                    <label for="txtID" class="form-label">Id:</label>
                    <asp:TextBox ID="txtID" runat="server" CssClass="form-control" />
                </div>
                <br />
                <asp:Button ID="btnSearch" runat="server" Text="Cerca" CssClass="btn btn-primary" OnClick="LoadDipendente"/>
                <br />
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <asp:TextBox ID="txtCognome" runat="server" CssClass="form-control" ReadOnly="true" />
                </div>
                <div class="mb-3">
                    <label for="txtEta" class="form-label">Età:</label>
                    <asp:TextBox ID="txtEta" runat="server" CssClass="form-control" ReadOnly="true" />
                </div>
